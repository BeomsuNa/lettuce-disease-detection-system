...
export const SAMPLES: Sample[] = [
  {
    id: '1',
    thumbnail: '/samples/images/Sample1.webp',
    image: '/samples/images/Sample1.webp',
    label: 'Sample 01',
    json: '/samples/labels/sample1.json',
    insights: ['상추균핵병 감지', '높은 수준의 감지', '넓은 범위'],
  },
  {
    id: '2',
    thumbnail: '/samples/images/Sample2.webp',
    image: '/samples/images/Sample2.webp',
    label: 'Sample 02',
    json: '/samples/labels/sample2.json',
    insights: ['상추노균병 감지', '중간 수준의 감지', '좁은 범위'],
  },
  {
    id: '3',
    thumbnail: '/samples/images/Sample3.webp',
    image: '/samples/images/Sample3.webp',
    label: 'Sample 03',
    json: '/samples/labels/sample3.json',
    insights: ['상추노균병 감지', '중간 수준의 탐지', '좁은 범위'],
  },
  {
    id: '4',
    thumbnail: '/samples/images/Sample4.webp ',
    image: '/samples/images/Sample4.webp ',
    label: 'Sample 04',
    json: '/samples/labels/sample4.json',
    insights: ['상추균핵병 감지', '중간 수준의 탐지', '넓은 범위'],
  },
  {
    id: '5',
    thumbnail: '/samples/images/Sample5.webp',
    image: '/samples/images/Sample5.webp',
    label: 'Sample 05',
    json: '/samples/labels/sample5.json',
    insights: ['상추균핵병 감지', '낮은 수준의 탐지', '매우 좁은 범위'],
  },
  {
    id: '6',
    thumbnail: '/samples/images/Sample6.webp',
    image: '/samples/images/Sample6.webp',
    label: 'Sample 06',
    json: '/samples/labels/sample6.json',
...
export const SUCCESS_CASES: SuccessCase[] = [
  {
    id: 's1',
    image: '/sucessCase/images/sucessSample1.webp',
  ...
  {
    id: 's2',
    image: '/sucessCase/images/sucessSample2.webp',
...
export const FAILURE_CASES: FailureCase[] = [
  {
    id: 'f1',
    image: '/failCase/FailSample1.webp',
  ...
  {
    id: 'f2',
    image: '/failCase/FailSample2.webp',
  ...
  {
    id: 'f3',
    image: '/failCase/FailSample3.webp',
